...
const AboutPage: React.FC = () => (
    <div className={styles.container}>
        ...
        <div>
            ...
            <p>through conversations with peers who shared a common curiosity with this emergent space, though with</p>
            <p>this curiosity comes trepidation — what does the future of NFT art look like? What are the implications of</p>
            <p>this movement for “legacy” art worlds? Chain/Saw was founded to further the challenging conversation</p>
            <p>surrounding the future of digital art, engaging a community of artists, inspired collectors, and curious</p>
            <p>audiences alike.</p>
